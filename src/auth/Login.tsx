import { Box, Card, CardContent, Tab, Tabs, Typography } from 'ud-ui-toolkit';
...
function Login() {
  ...
  return (
    <Box
      className={clsx(
        classes.root,
        'flex flex-col h-screen flex-auto items-center justify-center flex-shrink-0 p-16 md:p-24'
      )}
    >
      <motion.div
