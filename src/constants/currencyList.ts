let currencyList = [
  ...
  { cc: "ARS", symbol: "AR$", name: "Argentine peso" },
  { cc: "AUD", symbol: "AU$", name: "Australian dollar" },
  ...
  { cc: "MXN", symbol: "MX$", name: "Mexican peso" },
